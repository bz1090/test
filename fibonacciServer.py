...
if __name__ == '__main__':  # pragma: no cover
    ...
    parser.add_option('-b', '--bind', default='127.0.0.1', help=('Bind address, default 127.0.0.1, use ','"0.0.0.0" for all'))
    parser.add_option('-p', '--port', type='int', default=8080,  help='Listen port, default is 8080')
